            ...
            <div className="space-y-4 rounded-lg border p-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="show-tool-calls">도구 사용 내역 표시</Label>
                  <p className="text-sm text-muted-foreground">
                    AI가 사용하는 도구(함수)의 호출 내역을 화면에 표시합니다
                  </p>
                </div>
                <Switch
                  id="show-tool-calls"
                  checked={userSettings.showToolCalls}
                  onCheckedChange={(checked) =>
                    updateUserSettings({ showToolCalls: checked })
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  disabled={!userSettings.showToolCalls}
                />
              </div>
