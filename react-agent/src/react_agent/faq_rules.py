...
배출권 구매는 Carbon AIX 플랫폼을 통해 간편하게 진행하실 수 있습니다.

📚 **구매 절차:**

```mermaid
flowchart TD
    A["Carbon AIX 회원가입"] --> B["기업 인증 완료"]
    B --> C["배출권 조회 및 선택"]
    C --> D["구매 신청서 작성"]
    D --> E["가격 협의 및 계약"]
    E --> F["대금 결제"]
...
보유하신 배출권을 Carbon AIX 플랫폼을 통해 판매하실 수 있습니다.

📚 **판매 절차:**

```mermaid
flowchart TD
    A["보유 배출권 확인"] --> B["Carbon AIX 판매 등록"]
    B --> C["판매 가격 설정"]
    C --> D["구매자 매칭"]
    D --> E["가격 협의 및 계약"]
    E --> F["배출권 이전"]
...
""",
    ...
    # Carbon AIX 서비스
    "Carbon AIX 서비스": """💡 **Carbon AIX 서비스 소개**
...
""",
    ...
    # Carbon AIX 플랫폼
    "netz 플랫폼 사용법": """💡 **Carbon AIX 플랫폼 사용 가이드**

Carbon AIX는 탄소 배출권 거래 및 관리를 위한 올인원 플랫폼입니다.
